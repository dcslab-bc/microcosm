...
sed -i "s/timeout_propose = \"10s\"/timeout_propose = \"1s\"/g" $CURRENT_DATA_DIR/config/config.toml
sed -i "s/timeout_propose_delta = \"500ms\"/timeout_propose_delta = \"50ms\"/g" $CURRENT_DATA_DIR/config/config.toml

sed -i "s/timeout_prevote = \"1s\"/timeout_prevote = \"165ms\"/g" $CURRENT_DATA_DIR/config/config.toml
sed -i "s/timeout_prevote_delta = \"500ms\"/timeout_prevote_delta = \"50ms\"/g" $CURRENT_DATA_DIR/config/config.toml

sed -i "s/timeout_precommit = \"1s\"/timeout_precommit = \"65ms\"/g" $CURRENT_DATA_DIR/config/config.toml
sed -i "s/timeout_precommit_delta = \"500ms\"/timeout_precommit_delta = \"50ms\"/g" $CURRENT_DATA_DIR/config/config.toml

sed -i "s/timeout_commit = \"10s\"/timeout_commit = \"1s\"/g" $CURRENT_DATA_DIR/config/config.toml
